...
int main(int argc, char *argv[])
{
  ...
  RUN_TESTS(
    ...
    test_assert_true_no_double_evaluate,
    test_assert_false_pass,
    test_assert_false_fail,
    test_assert_false_no_double_evaluate,
    ...
    test_assert_lt_lt,
    test_assert_lt_eq,
    test_assert_lt_no_double_evaluate,
    test_assert_ge_gt,
    test_assert_ge_lt,
    test_assert_ge_eq,
    test_assert_ge_no_double_evaluate,
    test_assert_le_gt,
    test_assert_le_lt,
    test_assert_le_eq,
    test_assert_le_no_double_evaluate,
    test_assert_eq_gt_with_ne,
    test_assert_eq_gt,
    test_assert_eq_lt,
    test_assert_eq_eq,
    test_assert_eq_no_double_evaluate,
    test_assert_ne_eq_with_gt,
    test_assert_ne_gt,
    test_assert_ne_lt,
    test_assert_ne_eq,
    test_assert_ne_no_double_evaluate,
